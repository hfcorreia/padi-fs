...
namespace CommonTypes
{
    ...
    public class MetaInformationReader
    {
        ...
        private MetaInformationReader()
        {
                ...
                ServerObjectWrapper mds1wrapper = new ServerObjectWrapper( Int32.Parse( Properties.Resources.MDS1_PORT ), 1, Properties.Resources.MDS1_Host );
                ServerObjectWrapper mds2wrapper = new ServerObjectWrapper( Int32.Parse( Properties.Resources.MDS2_PORT ), 2, Properties.Resources.MDS2_Host );
                ServerObjectWrapper mds3wrapper = new ServerObjectWrapper( Int32.Parse( Properties.Resources.MDS3_PORT ), 3, Properties.Resources.MDS3_Host );
